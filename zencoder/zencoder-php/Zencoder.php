...
if(!class_exists('ZencoderOutputFile')) {
...
if(!class_exists('ZencoderRequest')) {
...
if(!class_exists('ZencoderCURL')) {
	class ZencoderCURL {
	  ...
	  var $options = array(
		...
		CURLOPT_SSL_VERIFYPEER => false, // uncomment this line if you get no gateway response.
	  );
...
if(!class_exists('ZencoderOutputNotification')) {
